...
Event_Class::Event_Class(std::shared_ptr<Branches> data, std::shared_ptr<Histogram> _hists, int run_type, int data_set){ 
	...
	if(data->Branches::q(0)==-1 && data->Branches::cc(0)!=0 && data->Branches::dc(0)!=0 && data->Branches::sc(0)!=0 && data->Branches::ec(0)!=0){//Sanity are q = -1, cc, dc, ec, and sc hits
		...
		if(cuts::fid_cut(0,data->Branches::p(0),data->Branches::cx(0),data->Branches::cy(0),data->Branches::cz(0))){
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,2,0,_W,data->Branches::p(0));
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,2,1,_W,data->Branches::p(0));
		...
		if(cuts::sf_cut(data->Branches::p(0),data->Branches::etot(0),data->Branches::cx(0),data->Branches::cy(0))){
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,3,0,_W,data->Branches::p(0));
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,3,1,_W,data->Branches::p(0));
		...
		if(cuts::min_cc(data->Branches::cc_segm(0),data->Branches::cc_sect(0),data->Branches::nphe(0))){
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,4,0,_W,data->Branches::p(0));
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,4,1,_W,data->Branches::p(0));
		...
		if(fid_e_pass && sf_e_pass){
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,5,0,_W,data->Branches::p(0));
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,5,1,_W,data->Branches::p(0));
		...
		if(fid_e_pass && cc_e_pass){
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,6,0,_W,data->Branches::p(0));
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,6,1,_W,data->Branches::p(0));
		...
		if(sf_e_pass && cc_e_pass){//SF and Min CC
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,7,0,_W,data->Branches::p(0));
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,7,1,_W,data->Branches::p(0));
		...
		if(fid_e_pass && cc_e_pass && sf_e_pass){//EID
			_hists->Histogram::WQ2_Fill(0,8,_W,_Q2);
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,8,0,_W,data->Branches::p(0));
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,8,1,_W,data->Branches::p(0));
		...
		if((data->Branches::id(0))==ELECTRON){
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,9,0,_W,data->Branches::p(0));
			...
			_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,9,1,_W,data->Branches::p(0));
		...
		_hists->Histogram::Fid_Fill(0,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,1,1,_W,data->Branches::p(0));
		...
		if(good_pro > 0 && good_pim >0){
			if( good_pro > 1){
				if(good_pim > 1){//Multiple proton and pi-
					for(int i = 0; i < good_pro; i++){
						for( int j = 0; j < good_pim; j++){
							...
							test_pim = physics::Make_4Vector(ppim[j],cxpim[j],cypim[j],czpim[j],mpi);
							if((physics::MM_event(0,0,_elec,test_pro,test_pim) > (p_center-p_sig))&&(physics::MM_event(0,0,_elec,test_pro,test_pim) < (p_center+p_sig))){
								_pim = test_pim;
								_pro = test_pro;
								top_possible[1]=true;
								d[2] = dpim[j];
					...
					for(int i = 0; i < good_pro; i++){
						test_pro = physics::Make_4Vector(ppro[i],cxpro[i],cypro[i],czpro[i],mp);
						if((physics::MM_event(0,0,_elec,test_pro,_pim) > (p_center-p_sig))&&(physics::MM_event(0,0,_elec,test_pro,_pim) < (p_center+p_sig))){
							_pro = test_pro;
							top_possible[1]=true;
							d[2] = dpim[0];
							t[2] = tpim[0];
				...
				if(good_pim > 1){//Multiple pi-, but only 1 good proton
					...
					for(int i = 0; i < good_pim; i++){
						test_pim = physics::Make_4Vector(ppim[i],cxpim[i],cypim[i],czpim[i],mpi);
						if((physics::MM_event(0,0,_elec,_pro,test_pim) > (p_center-p_sig))&&(physics::MM_event(0,0,_elec,_pro,test_pim) < (p_center+p_sig))){
							_pim = test_pim;
							top_possible[1]=true;
							d[2] = dpim[i];
							t[2] = tpim[i];
		...
		if(good_pro > 0 && good_pip >0){
			if( good_pro > 1){
				if(good_pip > 1){//Multiple proton and pi+
					for(int i = 0; i < good_pro; i++){
						for( int j = 0; j < good_pip; j++){
							...
							if((physics::MM_event(0,0,_elec,test_pro,test_pip) > (p_center-p_sig))&&(physics::MM_event(0,0,_elec,test_pro,test_pip) < (p_center+p_sig)) && (pro_idx[i]!=pip_idx[j])){
								_pip = test_pip;
								_pro = test_pro;
								top_possible[2]=true;
								d[1] = dpip[j];
					...
					for(int i = 0; i < good_pro; i++){
						test_pro = physics::Make_4Vector(ppro[i],cxpro[i],cypro[i],czpro[i],mp);
						if((physics::MM_event(0,0,_elec,test_pro,_pip) > (p_center-p_sig))&&(physics::MM_event(0,0,_elec,test_pro,_pip) < (p_center+p_sig))&& (pro_idx[i]!=pip_idx[0])){
							_pro = test_pro;
							top_possible[2]=true;
							d[1] = dpip[0];
							t[1] = tpip[0];
				...
				if(good_pip > 1){//Multiple pi+, but only 1 good proton
					...
					for(int i = 0; i < good_pip; i++){
						test_pip = physics::Make_4Vector(ppip[i],cxpip[i],cypip[i],czpip[i],mpi);
						if((physics::MM_event(0,0,_elec,_pro,test_pip) > (p_center-p_sig))&&(physics::MM_event(0,0,_elec,_pro,test_pip) < (p_center+p_sig))&& (pro_idx[0]!=pip_idx[i])){
							_pip = test_pip;
							top_possible[2]=true;
							d[1] = dpip[i];
							t[1] = tpip[i];
	...
	if(good_electron == 1){//Good Electron
		...
		if(top_possible[0]){//Good Pip and Pim
			...
			if((MM_p > (p_center-p_sig))&&(MM_p < (p_center+p_sig))){//Missing Mass Cut on Proton Mass
				...
				_hists->Histogram::Fid_Fill(1,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,10,0,_W,data->Branches::p(0));
				...
				//_hists->Histogram::WQ2_Fill(1,10,_W,_Q2);
				_hists->Histogram::Fid_Fill(1,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,10,1,_W,data->Branches::p(0));
		...
		if(top_possible[1]){//Good proton and Pim
			...
			if((MM_pip > (pip_center-pip_sig))&&(MM_pip < (pip_center+pip_sig))){//Missing Mass Cut on proton Mass
				...
				_hists->Histogram::Fid_Fill(2,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,10,0,_W,data->Branches::p(0));
				...
				for(int i = 0; i<2; i++){
					...
					_hists->Histogram::Fid_Fill(2,physics::get_theta(cz[par]),physics::get_phi(cx[par],cy[par]),par+1,6,0,_W,_p[par]);
					_hists->Histogram::DT_Fill(2,par,_p[par], d[par], t[par], data->Branches::sc_r(0), data->Branches::sc_t(0),6,0,_W,physics::get_sector(physics::get_phi(cx[par],cy[par])));
				}
			}else{
				...
				//_hists->Histogram::WQ2_Fill(2,10,_W,_Q2);
				_hists->Histogram::Fid_Fill(2,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,10,1,_W,data->Branches::p(0));
				...
				for(int i = 0; i<2; i++){
					...
					_hists->Histogram::Fid_Fill(2,physics::get_theta(cz[par]),physics::get_phi(cx[par],cy[par]),par+1,6,1,_W,_p[par]);
					_hists->Histogram::DT_Fill(2,par,_p[par], d[par], t[par], data->Branches::sc_r(0), data->Branches::sc_t(0),6,1,_W,physics::get_sector(physics::get_phi(cx[par],cy[par])));
				}
			}
		}
		...
		if(top_possible[2]){//Good Proton and Pip
			...
			//	std::cout<<std::endl <<"PIM Missing topology passed";
				...
				_hists->Histogram::Fid_Fill(3,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,10,0,_W,data->Branches::p(0));
				...
				//_hists->Histogram::WQ2_Fill(3,10,_W,_Q2);
				_hists->Histogram::Fid_Fill(3,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,10,1,_W,data->Branches::p(0));
		...
		if(top_possible[3]){//Good Proton Pip and Pim 
			...
			if((MM_z2 > (MM_zero_center2-MM_zero_sigma2))&&(MM_z2 < (MM_zero_center2+MM_zero_sigma2))){//Missing Mass Cut on Proton Mass
				...
				_hists->Histogram::Fid_Fill(4,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,10,0,_W,data->Branches::p(0));
				...
				//_hists->Histogram::WQ2_Fill(4,10,_W,_Q2);
				_hists->Histogram::Fid_Fill(4,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,10,1,_W,data->Branches::p(0));
	...
	if(_top!=0){
		...
		_hists->Histogram::Fid_Fill(5,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,10,0,_W,data->Branches::p(0));
		...
		for(int par = 0; par<3; par++){
			if(topo[3]){
				_hists->Histogram::Fid_Fill(5,physics::get_theta(cz[par]),physics::get_phi(cx[par],cy[par]),par+1,6,0,_W,_p[par]);
				_hists->Histogram::DT_Fill(5,par,_p[par], d[par], t[par], data->Branches::sc_r(0), data->Branches::sc_t(0),6,0,_W,physics::get_sector(physics::get_phi(cx[par],cy[par])));
		...
		_hists->Histogram::Fid_Fill(5,physics::get_theta(data->Branches::cz(0)),physics::get_phi(data->Branches::cx(0),data->Branches::cy(0)),0,10,1,_W,data->Branches::p(0));
