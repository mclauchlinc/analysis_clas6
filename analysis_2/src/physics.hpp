...
namespace physics{
	...
	float get_theta(TLorentzVector p0);//in lab frame
	...
	float Get_phie(TLorentzVector k_mu, TLorentzVector p0);
	void Rotate_4Vec(float theta, float phi, float phie, TLorentzVector &p1); //Rotate Four vectors along the theta and phi angles
	...
	void COM_gp(TLorentzVector _k_mu, TLorentzVector &p0, TLorentzVector &p1, TLorentzVector &p2, TLorentzVector &p3,TLorentzVector &p4, TLorentzVector &p5); //Bring four vectors into the COM reference frame for excited nucleon 
